# CodeRisk Agent v0.3.2 - Complete Source Code
...
|-- docs/
|   |-- rocm-optimization.md     # ROCm optimization docs
...
## 20. `docs/submission-checklist.md`
...
## 22. `tests/test_static_analyzer.py`
...
## 23. `tests/test_cases/buffer_overflow.c`
...
## 24. `tests/test_cases/command_injection.c`
...
## 25. `tests/test_cases/code_injection.py`
...
## 26. `tests/test_cases/memory_issues.c`
...
## 27. `tests/test_cases/sql_injection.py`
...
```
fd0cac0 v0.3.2: Report enhancement + ROCm docs + submission checklist
...
> Generated: 2026-07-19 15:05 | Version: v0.3.2